...
class KirkaChatBot:
    ...
    async def _handle_type_2(self, packet: Dict[str, Any], ws: aiohttp.ClientWebSocketResponse) -> None:
        ...
        if cmd_name in self.commands:
            log.info(f"CMD: {cmd_name} IN: {list(self.commands.keys())}")
            try:
    ...
    def add_command(self, name: str, handler: Union[Callable[[Dict[str, Any]], str], Callable[[Dict[str, Any]], Awaitable[str]]]) -> None:
